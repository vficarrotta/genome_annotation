...
# Create a small env with liftoff + minimap2 (gffread exists)
# Bioconda happiest with python 3.10
...
# If it fails to compile on node, continue anyway.
curl -sL https://cpanmin.us | "$EVM_PERL/bin/perl" - -L "$AGAT_PERL5" --notest \
